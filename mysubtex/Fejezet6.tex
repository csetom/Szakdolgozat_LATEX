...
A modellt be kell tanítanom a gyűjtött adatokkal. Ehhez a legegyszerűbb, ha az adataimat egy JSON fájlba összefűzöm, így a scriptnek elég ezt az egy fájlt beolvasnia. 
