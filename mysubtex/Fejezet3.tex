...
Megvizsgáltam a további lehetősségeimet is. Használhattam volna Unreal Engine-t \cite{unrealengine}, mely egy magas szintű 3D játékok fejlesztésére szakosodott játékmotor.
Azonban túl nagy volt a rendszerkövetelménye. A másik lehetősségem a Unity volt.
Összehasonlítottam a Unity-t \cite{UnityRea46:online} a Godot-al és arra jutottam, hogy a Godot GDScript nyelve sokkal könnyebben használható, mint a Unity C++ nyelve, így végül a Godot mellett döntöttem. 

\section{GDScript}
A GDScript\cite{GDScript64:online} a Godot Engine saját szkriptelési nyelve, amelyet a játékfejlesztéshez terveztek. 
